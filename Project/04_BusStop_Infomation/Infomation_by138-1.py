...
input_file = 'refine/busStop_Refine_by138-1.csv'
output = 'Information/information_predict_arrive_busStop_by138-1'

header = ['BusStop_No', 'BusStop_Name', 'Bus_No', 'Predict_Arrive', 'Current_Time']
data_frame = pd.read_csv(input_file, encoding='euc-kr')

arr_num = []
for num in range(32,59):
    arr_num.append(num)
for num in range(90,118):
    arr_num.append(num)
